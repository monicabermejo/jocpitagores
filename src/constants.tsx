    ...
    problems: [
      {
        ...
        hint: {
          ca: 'Recorda: a² + b² = c². Aquí a=6 i b=8. Calcula 6²+8²=36+64=100. La hipotenusa és √100.',
          es: 'Recuerda: a² + b² = c². Aquí a=6 y b=8. Calcula 6²+8²=36+64=100. La hipotenusa es √100.',
        },
      ...
      },
      {
        ...
        hint: {
          ca: 'El conducte forma un triangle rectangle: un catet és [CHAIN] (vertical, resultat anterior) i l\'altre és 24 (horitzontal). Calcula [CHAIN]²+24² i troba l\'arrel.',
          es: 'El conducto forma un triángulo rectángulo: un cateto es [CHAIN] (vertical, resultado anterior) y el otro es 24 (horizontal). Calcula [CHAIN]²+24² y encuentra la raíz.',
        },
      ...
      },
      {
        ...
        hint: {
          ca: 'Ara coneixes la hipotenusa ([CHAIN]) i un catet (24). Usa a²+b²=c²: alçada²+24²=[CHAIN]². Despeça l\'alçada.',
          es: 'Ahora conoces la hipotenusa ([CHAIN]) y un cateto (24). Usa a²+b²=c²: altura²+24²=[CHAIN]². Despeja la altura.',
        },
    ...
    problems: [
      {
        ...
        hint: {
          ca: 'Catets: a=5 (horitzontal) i b=12 (vertical). Calcula 5²+12²=25+144=169. La columna és √169.',
          es: 'Catetos: a=5 (horizontal) y b=12 (vertical). Calcula 5²+12²=25+144=169. La columna es √169.',
        },
      ...
      },
      {
        ...
        hint: {
          ca: 'Hipotenusa=[CHAIN], un catet=5. Usa a²+b²=c²: alçada²+5²=[CHAIN]². Despeça l\'alçada.',
          es: 'Hipotenusa=[CHAIN], un cateto=5. Usa a²+b²=c²: altura²+5²=[CHAIN]². Despeja la altura.',
        },
      ...
      },
      {
        ...
        hint: {
          ca: 'Catets: [CHAIN] (vertical, resultat anterior) i 16 (horitzontal). Calcula [CHAIN]²+16² i troba l\'arrel.',
          es: 'Catetos: [CHAIN] (vertical, resultado anterior) y 16 (horizontal). Calcula [CHAIN]²+16² y encuentra la raíz.',
        },
    ...
    problems: [
      {
        ...
        hint: {
          ca: 'Catets: a=9 (base) i b=12 (alçada). Calcula 9²+12²=81+144=225. L\'escala és √225.',
          es: 'Catetos: a=9 (base) y b=12 (altura). Calcula 9²+12²=81+144=225. La escalera es √225.',
        },
      ...
      },
      {
        ...
        hint: {
          ca: 'Catets: [CHAIN] (vertical, resultat anterior) i 20 (horitzontal). Calcula [CHAIN]²+20² i troba l\'arrel.',
          es: 'Catetos: [CHAIN] (vertical, resultado anterior) y 20 (horizontal). Calcula [CHAIN]²+20² y encuentra la raíz.',
        },
      ...
      },
      {
        ...
        hint: {
          ca: 'Hipotenusa=[CHAIN], un catet=7. Usa a²+b²=c²: alçada²+7²=[CHAIN]². Calcula [CHAIN]²-7² i troba l\'arrel.',
          es: 'Hipotenusa=[CHAIN], un cateto=7. Usa a²+b²=c²: altura²+7²=[CHAIN]². Calcula [CHAIN]²-7² y encuentra la raíz.',
        },
      ...
      },
      {
        ...
        hint: {
          ca: 'Catets: [CHAIN] (horitzontal, resultat anterior) i 10 (vertical). Calcula [CHAIN]²+10² i troba l\'arrel.',
          es: 'Catetos: [CHAIN] (horizontal, resultado anterior) y 10 (vertical). Calcula [CHAIN]²+10² y encuentra la raíz.',
        },
